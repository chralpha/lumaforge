...
- Live benchmark rows in this document are Luma-only prototype validation runs. Independent source-built release evidence is recorded in `docs/plans/2026-04-24-luma-raw-runtime-independent-benchmark-notes.md`.
...
- The V2 rollout gate was recorded as passing in the prototype context; it is superseded as release evidence by the 2026-04-24 independent native-build gates.
...
- This V2 gate result is historical prototype context only, not evidence for independent native-build release readiness.
