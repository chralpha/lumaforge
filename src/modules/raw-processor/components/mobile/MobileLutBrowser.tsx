                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="grid gap-1">
                        ...
                        <ContractChip
                          ...
                          tone={needsOutputContract ? 'warning' : 'neutral'}
                        />
                      </div>
                      {needsOutputContract && (
                        <p className="m-0 rounded-md border border-amber-400/35 bg-amber-400/10 px-2.5 py-2 text-xs leading-relaxed text-amber-100">
                            ...
                            <div className="grid gap-1">
                              ...
                              {visibleSuggestions.map((profile) => (
                                <MobileContractOptionButton
                                  ...
                                  active={draftInputProfile?.id === profile.id}
                                  highlighted
                                  onClick={() => handleInputSelect(profile)}
                                >
                          ...
                          {suggestedOutputOptions.length > 0 && (
                            <div className="grid gap-1">
                              ...
                              {suggestedOutputOptions.map((option) => (
                                <MobileContractOptionButton
                                  key={option.id}
                                  ariaLabel={t('raw.lutContract.useOutput', {
                                    label: option.label,
                                  })}
                                  active={activeOutputOptionId === option.id}
                                  highlighted
