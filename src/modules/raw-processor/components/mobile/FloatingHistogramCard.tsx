...
export function FloatingHistogramCard(props: {
  ...
  return (
    <div
      ...
      className={clsxm(
        'pointer-events-none absolute right-3 top-safe-offset-20 z-[15] w-[148px] rounded-md border border-lf-on-photo-bord bg-lf-on-photo-bg-strong p-2 text-lf-hero-ink shadow-lg backdrop-blur-background transition-opacity duration-200',
